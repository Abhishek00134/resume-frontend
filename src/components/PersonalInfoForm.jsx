import { BanIcon, BriefcaseBusiness, Globe, Icon, Mail, MapPin, Phone, SquareChevronRightIcon, User } from 'lucide-react'
...
const PersonalInfoForm = ({data,onChange, removeBackground, setRemoveBackground}) => {
    ...
    const fields = [
        ...
        {key:"linkedin",label: "LinkedIn Profile", icon: SquareChevronRightIcon, type: 'url'},
